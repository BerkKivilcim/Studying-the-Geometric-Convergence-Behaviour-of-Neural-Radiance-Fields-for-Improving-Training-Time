...
# Add these imports to your existing imports in train.py
from nerfstudio.scripts.exporter import ExportPointCloud, eval_setup
from nerfstudio.configs.method_configs import AnnotatedBaseConfigUnion
from pathlib import Path

# Diğer mevcut importlarınızın devamı
